    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#2D98EA] to-[#1A65B0] text-white py-20 snap-start fade-in">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-extrabold text-center mb-12 text-white fade-in">
            Våre Tjenester
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="flex flex-col items-center p-8 bg-white text-gray-800 rounded-xl shadow-xl hover:scale-105 transform transition duration-300 ease-in-out">
              ...
              <p className="text-lg text-center">
                Vi hjelper deg med kjøp og salg av eiendom, enten du er
                førstegangskjøper eller erfaren investor.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-white text-gray-800 rounded-xl shadow-xl hover:scale-105 transform transition duration-300 ease-in-out">
              <h3 className="text-2xl font-semibold mb-4">
              ...
              <p className="text-lg text-center">
                Vår ekspertise innen utleie og forvaltning sikrer deg pålitelig
                og profesjonell service gjennom hele prosessen.
              </p>
            </div>
            <div className="flex flex-col items-center p-8 bg-white text-gray-800 rounded-xl shadow-xl hover:scale-105 transform transition duration-300 ease-in-out">
              <h3 className="text-2xl font-semibold mb-4">
              ...
              <p className="text-lg text-center">
                Vi gir grundig rådgivning og veiledning for investeringer i
                eiendom, slik at du kan gjøre informerte valg.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-20 snap-start fade-in">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <h2 className="text-6xl font-bold mb-10 text-center text-white fade-in">
            Vårt Team
          </h2>
